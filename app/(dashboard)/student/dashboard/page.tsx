...
import { AssignedQuizzes } from "@/components/student/assigned-quizzes"
      ...
      <Tabs defaultValue="overview" className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            ...
            <Card className="col-span-3">
              <CardHeader>
                ...
                <CardDescription>Quizzes assigned to you</CardDescription>
              </CardHeader>
              <CardContent>
                <AssignedQuizzes />
              </CardContent>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            <Card className="col-span-4">
              <CardHeader>
                ...
                <CardDescription>Your recent quiz attempts and completions</CardDescription>
              </CardHeader>
              <CardContent>
                <RecentActivity />
              </CardContent>
        ...
        <TabsContent value="quizzes" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>View all your assigned and completed quizzes</CardDescription>
            </CardHeader>
            <CardContent className="h-[400px] flex items-center justify-center">
              <p className="text-muted-foreground">Quiz list will be displayed here</p>
            </CardContent>
          </Card>
        </TabsContent>
        <TabsContent value="progress" className="space-y-4">
          <Card>
            ...
            <CardContent className="h-[400px] flex items-center justify-center">
              <p className="text-muted-foreground">Progress details will be displayed here</p>
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
